    ...
    'default' => [
        ...
        'middleware' => [
            LogMiddleware::class => [
                ...
                'channel' => 'jsonrpc',
                'hideParams' => [
                    \App\Http\Controllers\Api\EctoController::class => ['account', 'tax_code', 'legal_entity_name']
                ]
            ...
            TokenAuthMiddleware::class => [
                ...
                // Ключи доступа к API
                'tokens' => [
                    'all' => env('JSONRPC_ALL_TOKEN'),
                    'acquiring' => env('JSONRPC_ACQUIRING_TOKEN'),
                ],
            ],
            /*ServiceValidationMiddleware::class => [
                // Разрешенные сервера, которые могут авторизоваться под указанными сервисами
                'servers' => [
            ...
            AccessControlListMiddleware::class => [
                 ...
                 */
                'acl' => [
                    //'*' => '*', // todo disable after local test or move it to .env
                    \App\Http\Controllers\Api\EctoController::class => 'acquiring' // todo enable after test or move to .env
